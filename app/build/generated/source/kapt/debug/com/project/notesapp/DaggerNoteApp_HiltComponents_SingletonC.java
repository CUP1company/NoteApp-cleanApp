...
import com.project.notesapp.di.AppModule_ProvideNoteDatabaseFactory;
import com.project.notesapp.di.AppModule_ProvideNoteRepositoryFactory;
import com.project.notesapp.di.AppModule_ProvideNoteUseCasesFactory;
...
import com.project.notesapp.feature_note.presentation.MainActivity;
import com.project.notesapp.feature_note.presentation.add_edit_note.AddEditNoteViewModel;
import com.project.notesapp.feature_note.presentation.add_edit_note.AddEditNoteViewModel_HiltModules_KeyModule_ProvideFactory;
import com.project.notesapp.feature_note.presentation.notes.NotesViewModel;
import com.project.notesapp.feature_note.presentation.notes.NotesViewModel_HiltModules_KeyModule_ProvideFactory;
...
public final class DaggerNoteApp_HiltComponents_SingletonC extends NoteApp_HiltComponents.SingletonC {
  ...
  private volatile Object noteUseCases = new MemoizedSentinel();
  ...
  private NoteUseCases noteUseCases() {
    Object local = noteUseCases;
    if (local instanceof MemoizedSentinel) {
      synchronized (local) {
        local = noteUseCases;
        if (local instanceof MemoizedSentinel) {
          local = AppModule_ProvideNoteUseCasesFactory.provideNoteUseCases(noteRepository());
          noteUseCases = DoubleCheck.reentrantCheck(noteUseCases, local);
        }
      }
    }
    return (NoteUseCases) local;
  }
  ...
  private static final class ActivityRetainedCImpl extends NoteApp_HiltComponents.ActivityRetainedC {
    ...
    private static final class ViewModelCImpl extends NoteApp_HiltComponents.ViewModelC {
      ...
      private AddEditNoteViewModel addEditNoteViewModel() {
        return new AddEditNoteViewModel(singletonC.noteUseCases(), savedStateHandle);
      }
      ...
      private NotesViewModel notesViewModel() {
        return new NotesViewModel(singletonC.noteUseCases());
      }
      ...
      public Map<String, Provider<ViewModel>> getHiltViewModelMap() {
        return MapBuilder.<String, Provider<ViewModel>>newMapBuilder(2).put("com.project.notesapp.feature_note.presentation.add_edit_note.AddEditNoteViewModel", (Provider) addEditNoteViewModelProvider()).put("com.project.notesapp.feature_note.presentation.notes.NotesViewModel", (Provider) notesViewModelProvider()).build();
      }
      ...
      private static final class SwitchingProvider<T> implements Provider<T> {
        ...
        public T get() {
          switch (id) {
            case 0: // com.project.notesapp.feature_note.presentation.add_edit_note.AddEditNoteViewModel 
            return (T) viewModelCImpl.addEditNoteViewModel();

            case 1: // com.project.notesapp.feature_note.presentation.notes.NotesViewModel 
